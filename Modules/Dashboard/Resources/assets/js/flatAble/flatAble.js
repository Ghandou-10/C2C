...
import 'bootstrap-select5/dist/js/bootstrap-select';
...
import InternetConnectionMonitor from "../components/InternetConnectionMonitor.vue";
...
switch (lang) {
    case 'ar':
        import('bootstrap-select5/dist/js/i18n/defaults-ar_AR');
        break;
    case 'en':
        import('bootstrap-select5/dist/js/i18n/defaults-en_US');
        break;
    default:
...
Vue.component('check-internet', InternetConnectionMonitor);
