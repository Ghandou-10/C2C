@if(auth()->user()->hasPermission('delete_customers') && auth()->user()->isNot($customer))

    <a href="#customer-{{ $customer->id }}-delete-model" class="btn btn-outline-danger btn-sm"
       data-toggle="modal">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="modal-title-{{ $customer->id }}">@lang('accounts::customers.dialogs.delete.title')</h5>
