...
use Modules\Accounts\Http\Controllers\Api\ChangePasswordController;
...
Route::middleware('auth:sanctum')->group(
    function () {
        ...
        Route::post('change-password', [ChangePasswordController::class, 'user.profile.changePassword']);
